...
public class BlackJackMain implements MouseListener{
	...
	public void mouseClicked (MouseEvent e)
    {
		...
		{
			startframe.setVisible(false);
			JLabel Objective, CardValues, Betting, PlayerTurn, DealerTurn, DoublingDown;
			...
			Objective.setBounds(15, 30, 1000, 40); 
			...
			CardValues.setBounds(15, 100, 1000, 40);
			...
			Betting.setBounds(15, 170, 1000, 40);
			...
			PlayerTurn.setBounds(15, 240, 1000, 80);
			...
			DealerTurn.setBounds(15, 350, 1000, 80);
			...
			DoublingDown.setBounds(15, 460, 1000, 60);
